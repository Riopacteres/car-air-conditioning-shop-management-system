...
<h2>Inventorypart Details</h2>
    ...
    PartName: <input type="text" name="PartName" placeholder="Enter the part name" required><br><br>
    </div>
      <div class="input-field">
    Description: <input type="text" name="Description" placeholder="Provide a brief description"required><br><br>
    </div>
      <div class="input-field">
    QuantityInStock: <input type="number" name="QuantityInStock" placeholder="Enter stock quantity"required><br><br>
    </div>
      <div class="input-field">
    SupplierName:<input type="text" name="SupplierName" placeholder="Enter the supplier name"required><br><br>
    </div>
      <div class="input-field">
